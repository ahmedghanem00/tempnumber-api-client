 ...
 *
 */
class UnauthorizedServiceException extends ApiException
{
    /**
     *
     */
    ...
    {
        ClientException::__construct('Unauthorized access to this resource. Please recheck the configured api token');
    }
}
